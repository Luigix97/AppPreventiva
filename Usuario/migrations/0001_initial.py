    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expediente', models.IntegerField(blank=True, null=True, unique=True, verbose_name='Expediente')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='Correo electrónico')),
                ('imagen', models.ImageField(blank=True, null=True, upload_to=None, verbose_name='Imagen de perfil')),
